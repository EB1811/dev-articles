...
Lets create a variable, and a function to update that variable.\
[img]\
And that it!\
With our store created, lets import it into a React component.\
...
[img]\
As you can see, its very easy to set up a Zustand store.
